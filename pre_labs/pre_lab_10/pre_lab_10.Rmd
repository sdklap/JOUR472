...
**Task** Run the following code to load data. Describe what you see in the answer space below. What columns exist in this data? **Answer** OBJECTID, ZIPCODE2, ZIPNAME, EXISTING, ZIPCODE1, Shape_Leng, Shape_Area, geometry
...
**Task** Run the following code. Describe the output in the space below: what kind of information does it contain? **Answer** This opens up the spreadsheeet
...
**Task** Run the following code. Describe the output in the space below. **Answer** It is a map of Maryland that looks like it is divided by zip code on a longitude and lattitude grid
...
**Task** Run the following code. Describe the output in the space below. **Answer** nothing happened visually, but i'm assuming tigris was loaded
...
**Task** Run the following code. Describe the output in the space below. **Answer** It shows the data all as chr exept geometry, which is a multipolygon
...
**Task** Run the following code. Describe the output in the space below. **Answer** Now, it is only Maryland counties
...
**Task** Run the following code. Describe the output in the space below. **Answer** It looks like the counties of Maryland
...
**Task** Run the following code. Describe the output in the space below. **Answer** This looks strange. It is probably the outlines of counties and zip codes based on the code.
...
**Task** Run the following code. Describe the output in the space below. **Answer** This opens a datafrane that only shows the zip code and number for 2023
...
**Task** Run the following code. Describe the output in the space below. **Answer** This opens a new dataframe joininbg geography with forclosures
...
**Task** Run the following code. Describe the output in the space below. **Answer** This is a map of MD by zip code. The lighter the color, the more foreclosures. 
...
**Task** Run the following code. Describe the output in the space below. **Answer** This opens two dataframes. The first has 25 entries of forclosures and the second is census data.
...
**Task** Run the following code. Describe the output in the space below. **Answer**This added geomety
...
**Task** Run the following code. Describe the output in the space below. **Answer** This opened the dataframes
...
**Task** Run the following code. Describe the output in the space below. **Answer** Now, the column names match up.
...
**Task** Run the following code. Describe the output in the space below. **Answer** This combines the two dataframes
...
**Task** Run the following code. Describe the output in the space below. **Answer** This adds per capita
...
**Task** Run the following code. Describe the output in the space below. **Answer** This is a map of labled MD counties. The lighter color blue, the higher rate of notices.
...
**Task** Run the following code. Describe the output in the space below. **Answer** This changed the colors of the map
...
**Task** Run the following code. Describe the output in the space below. What regional patterns do you see? **Answer** Southern MD has a higher rate
