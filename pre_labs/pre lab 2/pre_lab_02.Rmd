...
**Answer** It is important to only show data that is relevant to whatever analysis you want to do.
...
**Answer** The valyes are year month day instead of month day year. I think that it has something to do with floor date.
...
**Answer** I think this code is figuring out what percent of total votes were for Wes Moore.
...
**Answer** It changed from a decimal to percentage
...
**Answer** This is less useful because pct_moore is the last column and the percentages start with the lowest one.
...
**Answer** str_to_lower: this converts to lowercase
str_to_title: first letter of each word capitalized
str_to_sentence: first letter of each sentence capitalized
...
**Answer** I think that the statement is showing us only addresses in the states listed. It is also changing the title of the state to the state's abbreviation.
...
**Answer** This makes sense to me as it makes summarizing easier and changes the state name to the abbreviation.
...
1. How many courses are about data?

2.  How many non-profits from Maryland are in the expenditure report?

3.  What counties in Maryland vote rebiblican vs. democrat?
