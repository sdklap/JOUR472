...
**Task** Run the following code to load the data. In the space below, indicate how many rows and columns it has. **Answer** 3,822 rows, 4 columns
...
**Task** Run the following code to add a month column to our dataframe using lubridate and count the number of calls for each month. In the space below, explain what each step of the code below is doing in English. Note the "label=TRUE" part in the mutate statement. **Answer** Line 58 is creating a new dataframe called baltco_911_calls_by_month. Label=TRUE means that months have their names, not numbers. So, January would be Jan and not 1. Line 59 is adding a month column. Line 60 is saying to show the month. Line 61 is adding a column called total_calls which counts the number of calls for month. Line 62 is sorting it by most number of calls.
...
**Task** Run the following code. Explain what you see after running the code in the space below. **Answer** I see a grey box
...
**Task** Run the following code. Explain what you see after running the code in the space below. **Answer** I see a bar chart that counts calls per month
...
**Task** Run the following code. Explain what you see after running the code in the space below. What has changed from the last codeblock? **Answer** Now, the months going from left to right are not in chronological order, they are sorted from least calls to most calls.
...
**Task** Run the following code. Explain what you see after running the code in the space below. What has changed from the last codeblock? **Answer** Months are now on the y axis and calls are on the x axis
...
**Task** Run the following code. Explain what you see after running the code in the space below. What has changed from the last codeblock? **Answer** The background is white not light grey
...
**Task** Run the following code. Explain what you see after running the code in the space below. What has changed from the last version of the chart? **Answer** The theme is different, the background is light blue
...
**Task** Run the following code. Explain what you see after running the code in the space below. What has changed from the last codeblock? **Answer** First, it added a title. Then, It changed the names of the z and y axis. It also added a caption to the bottom left.
...
**Task** Run the following code. Explain what you see after running the code in the space below. **Answer** I see the number of calls on a certain date
...
**Task** Run the following code. Explain what you see after running the code in the space below. **Answer** It changed the x axis labels to once a week
...
**Task** Run the following code. Explain what you see after running the code in the space below. **Answer** The dates at the bottom are now angular
