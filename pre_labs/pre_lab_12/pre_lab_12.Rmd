...
**Task** Run the following code in the gray-colored codeblock below to extract all tables in the HTML and save it as a dataframe. What do you notice about the columns? **Answer** I noticed that both are <chr>. The name is also uppercase, not press_releases or something like that. 
...
**Task** Run the following code to extract the table we want, clean up the names and change the date column to an actual date. Look at the dataframe; what other information about these releases might you want to add? **Answer** I'd want to add what county, zip code/GEOID, and other data along those lines. 
...
tags there are in the HTML source? **Answer** 20 tags
...
tags. Describe the output: **Answer** There are 112 lines, some are titles and some are full length dates and titles of press releases.
...
**Task** Run the following code in the gray-colored codeblock below to make a dataframe. Describe the output: **Answer** The output is a one column table that lists the values. 
