...
**A1** Engineering, Coorerative Education has the highest mean average. It is surprising that Library Sciences has the most total seats but such a low average number of seats.
...
**A2** 22 is the greatest number of times any individual class has been offered.
...
**Q3** Count the number of courses for each instructor and department. Which instructor has taught the most? **A3** Keith Yearwood taught 61 classes.
...
**Q4** Given the results for Q3, what would have made it easier to find the answer? You don't have to know *how* to accomplish this; I want you to describe in words what would make the answer easier to see. How confident are you that the answer you got is the right one, and why? **A4** I'd want to filter out the NA and TBA answers.

**Q5** Take one of the questions you listed in the final question of the pre_lab and try to answer it here in code. If you don't know how to fully answer it, write what code you can and describe in words what else you would need to do. If you got an answer, is it interesting? **A5** My question is: Why is mean class size for many stem subjects larger than those for humanities? I would need to filter by stem classes and humanities departments, but I figured out how to get the mean class size for every department.
