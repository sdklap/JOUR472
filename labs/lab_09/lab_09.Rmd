...
**A1.** https://www.datawrapper.de/_/msIwB/ I decided to do a stacked bar chart so you could see the direct comparison of the two candidates
...
gov_county <- gov_county |>
  ...
  mutate(HoganPercentage = (Hogan / sum(Hogan + Jealous + Quinn + Schlakman + `Write-ins.y`)) * 100)
...
**A2.**
https://www.datawrapper.de/_/vNjYy/

I think the story is that in person voting numbers have not returned to pre-covid numbers. 
...
https://www.datawrapper.de/_/2X5vl/

I think the story here is why there are so many calls in 20874. I want to know why, is there a rehab center?
