...
```{r echo=FALSE}
census_api_key("5f6c00075d91d0e888c5c6aeed75bbead5009687", install=TRUE)
```
...
Is the difference between Calvert and Montgomery significant? **Answer** Yes, it overlaps

Is the difference between Howard and everyone else significant? **Answer** Yes, it does not overlap
...
**Task** Let's look at the average household income for high schools that have 60% or more graduates immediately enrolling in college, and then look at those with less than 40%. Write a sentence describing the results. **Answer** The schools with more graduates do in fact have a higher household income. 
...
**Task** What is another question you could ask of this data? **Answer** You could ask about class size and income in the same way.
