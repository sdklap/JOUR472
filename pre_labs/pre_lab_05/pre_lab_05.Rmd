...
```{r}
voters_by_county <- read_csv("/Users/sdklap/JOUR472/JOUR472/pre_labs/pre_lab_05/data/tabula-Eligible Active Voters by County - GG22.csv")
...
```{r}
fentanyl_deaths <- read_csv("/Users/sdklap/JOUR472/JOUR472/pre_labs/pre_lab_05/data/tabula-Annual_2020_Drug_Intox_Report.csv", col_names = FALSE) |> clean_names()
...
```{r}
fentanyl_deaths <- read_csv("/Users/sdklap/JOUR472/JOUR472/pre_labs/pre_lab_05/data/tabula-Annual_2020_Drug_Intox_Report.csv", col_names = FALSE) |> 
  clean_names() |> 
