...
**Task** Run the following code and describe what the `unique` function does to the original list of words. **Answer** It removes the double "dog" and "cat"
...
**Task** Run the following code and describe the output of using the `unnest_tokens` function. **Answer** It looks like it pulled up a list of every single unique word in the data
...
**Task** Run the following code and describe what the resulting graphic shows. Is it interesting? **Answer** I would not say this is very interesting. This is what I would expect from the data.  
...
**Task** Run the following code and describe the results. Is it more interesting than before? **Answer** This is more interesting than before. this shows words that would be useful instead of words like "the" and "a"
...
**Task** Run the following code and describe the results. **Answer** This is the amount of times the word was used and the percent. "Health" was used much less in 2023 than 2021 and 2022. I would assume this is because of COVID. 
...
**Task** Run the following code and describe the results. **Answer** This is the same format as the previous table, but with two-word phrases. The most used was covid 19, which makes sense.
...
**Task** Run the following code and describe the results. **Answer** This is slightly different than before since it is just for 2022. "project location" is the most common phrase. 
...
**Task** Run the following code and describe the results. **Answer** Phrases overall were used less than 2022. This is probably because 2023 is not over yet. I wonder why "oral health" was so prevelant. 
...
**Task** Run the following code and describe the results. Do any of the sentiments seem incorrect or counter-intuitive? **Answer** This is so interesting that a computer can do this. "Trump" being positive seems to be incorrect in my mind, because of the meaning of the word and the former president. Based on a scan of the first 75 ish words for all three years, it seems fairly correct. 
